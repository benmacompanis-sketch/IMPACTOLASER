        ...
        {applications.map((app) => {
          ...
          return (
            <RevealChild key={app.title} className="h-full">
              <div className="group relative flex h-full flex-col justify-between overflow-hidden rounded-2xl border border-white/[0.07] bg-white/[0.02] p-5 transition-all duration-500 hover:-translate-y-1 hover:border-laser-500/40 hover:bg-laser-500/[0.05]">
